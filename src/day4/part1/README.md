...
Given the following list of passphrases, how may of them are valid?
...
:heavy_check_mark: `383`

The following code has been used to obtain this result with the specified input:
