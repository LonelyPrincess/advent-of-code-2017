...
describe("Day 5: A Maze of Twisty Trampolines, All Alike - Part I", function () {
  ...
  it("it takes 5 steps to escape sample maze [0, 3, 0, 1, -3]", function () {
    const maze = [0, 3, 0, 1, -3];
    expect(getStepsToEscape(maze)).toBe(5);
  });
